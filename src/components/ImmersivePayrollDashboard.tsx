    ...
    <div className="mx-auto w-full max-w-7xl space-y-6 px-3 pb-10 sm:px-4">
      ...
      >
        ...
        <div className="flex flex-col">
          <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-cyan-50 group-hover:text-cyan-300 transition-colors">Fhenix Arbitrum Sepolia</span>
